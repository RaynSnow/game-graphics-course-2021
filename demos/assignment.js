...
import {positions, normals, indices, uvs} from "../blender/Cybertron.js"
...
(async () => {
    ...
    const cubemap = app.createCubemap({
        negX: await loadTexture("noise.png"),
        posX: await loadTexture("noise.png"),
        negY: await loadTexture("noise.png"),
        posY: await loadTexture("noise.png"),
        negZ: await loadTexture("noise.png"),
        posZ: await loadTexture("noise.png")
    });
